...
ListModel {
    ...
    ListElement { name: "Publicidade"; feed: "g1.globo.com/dynamo/rss2.xml" }
    ListElement { name: "Principais"; feed: "g1.globo.com/dynamo/rss2.xml" }
    ListElement { name: "Brasil"; feed: "g1.globo.com/dynamo/brasil/rss2.xml" }
    ListElement { name: "Mundo"; feed: "g1.globo.com/dynamo/mundo/rss2.xml" }
